...
<div>
      ...
      <div class="flex justify-between items-center mt-3">
        ...
        <a :href="`/view/survey/${survey.slug}`"
          target="_blank"
          class="h-7 w-7 flex items-center justify-center rounded-full border border-transparent text-sm text-indigo-500 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
        >
